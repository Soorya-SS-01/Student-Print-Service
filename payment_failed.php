...
// Keep payment_details in session for retrying
?>
...
<head>
    ...
    <title>Payment <?php echo ucfirst($status); ?></title>
...
@media (max-width: 380px) {
    ...
    .dropdown-menu {
        ...
        .x-mark__line {
            ...
            animation: draw-x 0.3s ease-in-out 0.8s forwards;
            stroke-dasharray: 40;
...
<body>
    ...
    <div class="container">
        ...
        <div class="failed-animation">
            <svg class="circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
                <circle class="circle__background" cx="26" cy="26" r="25" fill="none"/>
            </svg>
            <svg class="x-mark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
                <line class="x-mark__line" x1="18" y1="18" x2="34" y2="34"/>
                <line class="x-mark__line" x1="34" y1="18" x2="18" y2="34"/>
            </svg>
        </div>
        
        <p>Your payment was <?php echo $status; ?>. Please try again or contact support.</p>
        ...
        <div>
            <a href="student.php" class="btn btn-retry">Try Again</a>
